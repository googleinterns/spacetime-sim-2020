...
if not os.path.exists(home_dir + '/flow/data'):
    os.makedirs(home_dir + '/flow/data')

em_path = home_dir + '/flow/data'
...
SHORT_LENGTH = 240  # length of edges that vehicles start on
...
for edge in outer_edges:
    if edge.__contains__("top") or edge.__contains__("bot"):
        vph = arterial
    else:
        vph = side_street
    inflow.add(
