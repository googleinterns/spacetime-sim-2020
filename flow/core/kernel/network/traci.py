...
from flow.core.util import makexml, printxml, ensure_dir, generate_demands
import time
import os
import subprocess
    ...
    def generate_cfg(self, net_params, traffic_lights, routes):
        ...
        for route_id in routes.keys():
            ...
            for i in range(len(routes[route_id])):
                ...
                route_list = route_list + ['route{}_{}'.format(route_id, i)]
        ...
        # sorted_ids, vehicle_str = generate_demands(segment_id_pairs=route_list, network_name=self.network.name, horizon=3600, is_uniform=True, num_of_vehicles=100)
        #
