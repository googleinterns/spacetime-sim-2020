...
def visualizer_rllib(args):
    ...
    # FIXME: overwrite flow_params initial config
    ...
    if args.gen_emission:
        ...
        trip_info = emission_to_csv(emission_path)
        ...
        # def log_travel_times(env, info):
        #     # get full trip durations
        #     iter = env.step_counter  # FIXME
        #     avg = info.travel_times.mean()
        #     env.writer.add_scalar('travel_times ', avg, iter)
        #
        # log_travel_times(pd.DataFrame(env, trip_info))
        #
        # os.remove(emission_path)
        # print("#############3")
        # print(dir_path)
...
def create_parser():
    ...
    parser.add_argument(
        '--result_dir',
        default="../../../ray_results/grid-trail/DQN_MyGridEnv-v0_0_2020-06-20_18-39-33162_c4m8/",
        help='Directory containing results')
    parser.add_argument('--checkpoint_num',
                        default='500',
                        type=str, help='Checkpoint number.')
